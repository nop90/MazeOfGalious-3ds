...
APP_TITLE		:= Maze Of Galious 
APP_DESCRIPTION	:= Maze Of Galious (MoG) classic MSX game remake
...
LIBS	:=  -lSDL_sound -lSDL_mixer -lmikmod -lmad -lvorbisidec -logg -lSDL_image -lSDL -lpng -ljpeg -lz -lcitro3d -lctru -lm
